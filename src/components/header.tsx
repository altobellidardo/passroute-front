      ...
      <div className='container mx-auto px-4 flex justify-between items-center'>
        ...
        {isAuthPage
          ...
          : (<div className='flex space-x-2'>
            <Link href='/auth/registro' className='border-2 text-purple-100 border-purple-600 hover:bg-purple-700 font-semibold py-1 px-4 rounded-lg transition-colors'>Registrarse</Link>
            <Link href='/auth/ingreso' className='border-2 border-purple-600 bg-purple-600 hover:bg-purple-700 text-purple-100 font-semibold py-1 px-4 rounded-lg transition-colors'>Ingresar</Link>
          </div>)
        }
      </div>
    </header>
